#!/bin/sh
n_run=1
env="algorithms/MALNovelD/scenarios/click_n_push3.py"
model_name="qmix_loc_e2snoveld_pol"
sce_conf_path="configs/3a_1o_polarge.json"
n_frames=10000000
...
--init_explo_rate ${init_explo_rate} --n_explo_frames ${n_explo_frames} --buffer_length ${buffer_length} \
